"""Client for the github-web environment.
...
Usage:
    ...
    env = make_env("login")  # Creates browsergym/github-web.login
    obs, info = env.reset()
...
def make_env(
    ...
    **kwargs,
    ...
    """Create a BrowserGym environment for a github-web task.
...
def list_tasks() -> list[dict]:
    """List all available tasks for github-web.
