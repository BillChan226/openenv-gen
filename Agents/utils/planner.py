...
Please provide a revised plan that addresses the feedback.
Respond with a JSON array of steps in the same format as before.
"""
    ...
    async def expand_step(
        ...
        prompt = f"""Expand the following step into more detailed sub-steps:
...
Break this down into 2-5 concrete sub-steps.
