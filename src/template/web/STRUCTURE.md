...
| `Avatar` | User avatars with fallback | Image loading, initials fallback |
| `Badge` | Labels, tags, status | Color variants, removable items |
| `Dropdown` | Menu interactions | Click outside, item selection |
