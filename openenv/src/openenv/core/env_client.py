...
class EnvClient(ABC, Generic[ActT, ObsT, StateT]):
    ...
    def __init__(
        ...
        max_message_size: int = 16 * 1024 * 1024,  # 16 MB default for large observations
        ...
        Args:
            ...
            max_message_size: Maximum WebSocket message size in bytes (default 16MB).
                             Increase for environments with large observations (e.g., screenshots).
